...
Nodejs:[
  {
    ...
    answer: "js is Server Side Language",
    options: [
    ...
    answer: "REPL stands for Read Eval Print Loop.",
    options: [
...
Php:[
...

  {
    ...
    answer: "The strlen() function returns the length of string",
    options: [
  ...
  
   {
    ...
    answer: "The strpos() function is used to search for a character/text in a string",
    options: [
...
Mongodb:[
  {
    ...
    {
    numb: 3,
    question: "in how much time the MongDB writes are written to the journal?",
    answer: "100 ms",
    options: [
      "100 s",
      "60 s",
    ...
    {
    numb: 5,
    question: "A collection in MongoDB is a group of",
  ...
  {
    numb: 6,
    question: "which field is always the first field in the document.?",
    answer: "_id",
    options: [
      "_id",
      "Ob_id",
   ...
   {
    numb: 8,
    question: "MongoDB is a ..... type database?",
    answer: "document",
    options: [
      "Relational",
      "objects",
   ...
   {
    numb: 9,
    question: "Which statements is correct about mongoose in MongoDB ?",
    answer: "It is used for modeling your application data in node.js",
    options: [
   ...
   {
    numb: 10,
    question: "The concatenation of the collection name and database name is called a -",
    answer: "Namespace",
    options: [
      "Namespace",
      "MongoDB",
